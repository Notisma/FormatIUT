...
class Personnels extends Utilisateur
{
    ...
    public function getFiltresRecherche(): array
    {
        return array(
            ...
            "filtre6"=>array("label"=>"Etudiants Avec Formations","value"=>"etudiant_avec_formation"),
            "filtre7"=>array("label"=>"Etudiants Sans Formations","value"=>"etudiant_sans_formation"),
