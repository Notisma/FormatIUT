        ...
        <form method="post">
            <fieldset>
                ...
                <p><label for="offre_id">Votre stage : </label>
                    ...
                    <?php
                        if($offre){
                            echo '<input value="'.htmlspecialchars($offre->getNomOffre()).'" name="nomOffre" id="offre_id"  readonly required>';
                            echo '<input type="hidden" value="'.$offre->getidFormation().'" name="idOff">';
                        }
                        else{
                ...
                <input type="submit" value="Envoyer" formaction="?action=creerConvention&service=Convention">
            </fieldset>
        </form>
    </div>
</div>
